...
function ChibiBarista({ faceImg, state, flip }) {
  ...
  return (
    <div style={{ position:'relative', width:72, display:'flex', flexDirection:'column', alignItems:'center', animation:anim, transform: flip ? 'scaleX(-1)' : 'none' }}>
      {/* Cap */}
      ...
      {/* Real face circle */}
      <div style={{ width:60, height:60, borderRadius:'50%', overflow:'hidden', border:'2px solid #c8943a', zIndex:2, flexShrink:0, margin:'0 auto' }}>
        <img src={faceImg} style={{ width:'100%', height:'100%', objectFit:'cover', objectPosition:'center 10%', transform: flip ? 'scaleX(-1)' : 'none' }} alt="barista"/>
      </div>
